		...
		<div className="grid lg:grid-cols-3 h-full">
			...
			>
				...
				<div>
					...
					<p className="text-lg text-white opacity-80 max-w-[700px]"> comes with a complete set of UI components crafted with Tailwind CSS, it fulfilled most of the use case to create modern and beautiful UI and application</p>
				</div>
