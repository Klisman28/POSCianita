                                            ...
                                            <div className="text-gray-900 dark:text-gray-300 flex items-center space-x-4">
                                                ...
                                                <div>
                                                    {product.stock > 0 ?
                                                        ...
                                                        <Tag className="bg-red-200 text-red-600 dark:bg-emerald-500/20 dark:text-emerald-100 rounded-md border-0 mx-2">
                                                            <span className="capitalize">
                                                                Agotado
                                                            </span>
                                                        </Tag>
                        ...
                        }
                        {
                            (productList.length === 0) && (
                                <div className="my-10 text-center text-amber-500 text-sm flex items-center justify-center space-x-2">
                                    ...
                                    <span>
                                        No hay productos que coencidan con el término
                                    </span>
